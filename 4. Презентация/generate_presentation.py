...
SLIDES = [
    ...
    },
    {
        ...
        "bullets": [
            ...
            "Предмет: растения и водные животные как биоиндикаторы состояния водной среды.",
            "Задачи: изучить метод биоиндикации, описать водоемы, проанализировать растения и животных, сравнить результаты.",
        ],
    },
    {
        "type": "outline",
    ...
    },
    {
        ...
        "bullets": [
            ...
            "Отмечены паровые водоросли, донные беспозвоночные и раки как дополнительные признаки.",
        ],
    },
    {
        "type": "outline",
        ...
        "bullets": [
            ...
            "Для Шершней доступны более выразительные данные по водным животным.",
    ...
    },
    {
        ...
        "bullets": [
            ...
            "Важны и прибрежные растения, и водные животные.",
        ],
    },
    {
        "type": "outline",
        ...
        "bullets": [
            ...
            "Ссылку на публикацию можно добавить на слайд.",
        ],
    },
    {
        "type": "title",
